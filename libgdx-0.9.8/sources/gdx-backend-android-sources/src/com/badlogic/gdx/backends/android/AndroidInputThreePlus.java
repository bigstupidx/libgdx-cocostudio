...
/**
 * Subclass of AndroidInput, used on Androd +3.x to get generic motion events for things like gampads/joysticks and so
 * on.
 * 
 * @author mzechner
 * 
...
public class AndroidInputThreePlus extends AndroidInput implements OnGenericMotionListener {
	...
	public AndroidInputThreePlus(Application activity, Context context, Object view,
