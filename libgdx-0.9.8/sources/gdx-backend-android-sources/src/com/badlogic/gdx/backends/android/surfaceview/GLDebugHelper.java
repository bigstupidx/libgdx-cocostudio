...
public class GLDebugHelper {
	 ...
	 * <p>
	 * Wrapping means that the GL instance that is passed in to this method is wrapped inside a new GL instance that
	 * optionally performs additional operations before and after calling the wrapped GL instance.
	 * <p>
	 * Error checking means that the wrapper will automatically call glError after each GL operation, and throw a
	 * GLException if an error occurs. (By design, calling glError itself will not cause an exception to be thrown.)
	 * Enabling error checking is an alternative to manually calling glError after every GL operation.
	 * <p>
	...
	/**
	 * The Error number used in the GLException that is thrown if CONFIG_CHECK_THREAD is enabled and you call OpenGL ES
	 * on the a different thread.
	 */
