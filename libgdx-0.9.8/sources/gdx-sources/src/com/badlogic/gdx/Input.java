...
/**
 * <p>
 * Interface to the input facilities. This allows to poll the state of the keyboard, touch screen and accelerometer. On
 * the desktop the touch screen is replaced by mouse input, the accelerometer is of course not available.
 * </p>
 * 
 * <p>
 * Additionally one can process events with an {@link InputProcessor} with this module. You can set the InputProcessor
 * via the {@link #setInputProcessor(InputProcessor)} method. It will be called before the
 * {@link ApplicationListener#render()} method in each frame.
 * </p>
 * 
 * <p>
 * Keyboard keys are translated to the constants in {@link Keys} transparantely on all systems. Do not use system
...
// ? | VK_QUESTION
	...
	/**
	 * @return the last touch x coordinate for the first pointer in screen coordinates. The screen origin is the top
	 *         left corner.
	 */
	public int getX();
	...
	/**
	 * @return the last touch y coordinate for the first pointer in screen coordinates. The screen origin is the top
	 *         left corner.
	 */
	public int getY();
	 ...
	 * Button#LEFT constant is meaningful.
	 * 
	 * @param button
	 *            the button to check.
