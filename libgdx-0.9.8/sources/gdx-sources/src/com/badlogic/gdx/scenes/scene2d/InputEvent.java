...
public class InputEvent extends Event {
	...
	/**
	 * The stage x coordinate where the event occured. Valid for: touchDown, touchDragged, touchUp, mouseMoved, enter,
	 * and exit.
	 */
	...
	/**
	 * The pointer index for the event. The first touch is index 0, second touch is index 1, etc. Always -1 on desktop.
