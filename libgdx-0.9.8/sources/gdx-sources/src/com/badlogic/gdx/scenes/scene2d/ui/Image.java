...
/**
 * Displays a {@link Drawable}, scaled various way within the widgets bounds. The preferred size is the min size of the
 * drawable. Only when using a {@link TextureRegionDrawable} will the actor's scale, rotation, and origin be used when
 * drawing.
 * 
 * @author Nathan Sweet
 */
		...
		if (drawable != null) {
			if (drawable.getClass() == TextureRegionDrawable.class) {
				...
				if (scaleX == 1 && scaleY == 1 && rotation == 0)
					...
					batch.draw(region, x + imageX, y + imageY, getOriginX() - imageX, getOriginY() - imageY,
