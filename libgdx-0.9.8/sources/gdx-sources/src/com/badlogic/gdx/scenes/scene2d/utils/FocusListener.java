...
abstract public class FocusListener implements EventListener {
	...
	static public class FocusEvent extends Event {
		...
		/**
		 * The actor related to the event. When focus is lost, this is the new actor being focused, or null. When focus
		 * is gained, this is the previous actor that was focused, or null.
		 */
