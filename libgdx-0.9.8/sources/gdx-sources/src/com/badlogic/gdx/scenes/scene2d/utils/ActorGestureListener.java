...
public class ActorGestureListener implements EventListener {
	...
	/**
	 * If true is returned, additional gestures will not be triggered. No event is provided because this event is
	 * triggered by time passing, not by an InputEvent.
	 */
