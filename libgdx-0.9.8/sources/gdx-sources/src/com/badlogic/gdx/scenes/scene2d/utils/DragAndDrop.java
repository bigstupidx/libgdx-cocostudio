...
public class DragAndDrop {
	...
	/**
	 * Time in milliseconds that a drag must take before a drop will be considered valid. This ignores an accidental
	 * drag and drop that was meant to be a click. Default is 250.
	 */
	...
	static abstract public class Target {
		...
		/**
		 * Called when the object is dragged over the target. The coordinates are in the target's local coordinate
		 * system.
		 * 
	...
	/**
	 * The payload of a drag and drop operation. Actors can be optionally provided to follow the cursor and change when
	 * over a target.
	 */
