...
/**
 * {@link AssetLoader} for {@link Skin} instances. All {@link Texture} and {@link BitmapFont} instances will be loaded
 * as dependencies. Passing a {@link SkinParameter} allows one to specify the exact name of the texture associated with
 * the skin. Otherwise the skin texture is looked up just as with a call to
 * {@link Skin#Skin(com.badlogic.gdx.files.FileHandle)}.
 * 
 * @author Nathan Sweet
 */
