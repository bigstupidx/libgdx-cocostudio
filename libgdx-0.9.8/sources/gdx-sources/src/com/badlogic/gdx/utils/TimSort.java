...
class TimSort<T> {
	 ...
	 * @param start
	 *            the index of the first element in the range that is not already known to be sorted (@code lo <= start
	 *            <= hi}
	 * @param c
	 ...
	 * @param hint
	 *            the index at which to begin the search, 0 <= hint < n. The closer hint is to the result, the faster
	 ...
	 *         infinity and a[b + n] is infinity. In other words, key belongs at index b + k; or in other words, the
	 *         first k elements of a should precede key, and the last n - k should follow it.
	 */
