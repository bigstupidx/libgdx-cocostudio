...
/**
 * A pausable thread. The runnable must not execute an inifite loop but should return control to the thread as often as
 * possible so that the thread can actually pause.
 * 
 * @author mzechner
 */
