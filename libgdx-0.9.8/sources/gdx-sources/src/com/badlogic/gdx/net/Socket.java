 ...
 * 
 * A socket has an {@link InputStream} used to send data to the other end of the connection, and an {@link OutputStream}
 * to receive data from the other end of the connection.</p>
 * 
