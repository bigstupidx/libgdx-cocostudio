...
/**
 * A color class, holding the r, g, b and alpha component as floats in the range [0,1]. All methods perform clamping on
 * the internal values after execution.
 * 
 * @author mzechner
 */
public class Color {
	...
	/**
	 * Packs the color components into a 32-bit integer with the format ABGR and then converts it to a float. Note that
	 * no range checking is performed for higher performance.
	 * 
	 * @param r
	...
	/**
	 * Packs the color components into a 32-bit integer with the format ABGR. Note that no range checking is performed
	...
	/**
	 * Sets the Color components using the specified integer value in the format RGB565. This is inverse to the
	 * rgb565(r, g, b) method.
	 * 
	 * @param color
	...
	/**
	 * Sets the Color components using the specified integer value in the format RGBA4444. This is inverse to the
	 * rgba4444(r, g, b, a) method.
	 * 
	 * @param color
	 *            The Color to be modified.
	 * @param value
	...
	/**
	 * Sets the Color components using the specified integer value in the format RGB888. This is inverse to the
	 * rgb888(r, g, b) method.
	 * 
	 * @param color
	 *            The Color to be modified.
	...
	/**
	 * Sets the Color components using the specified integer value in the format RGBA8888. This is inverse to the
	 * rgb8888(r, g, b, a) method.
	 * 
	 * @param color
	 *            The Color to be modified.
	 * @param value
