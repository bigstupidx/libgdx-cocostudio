...
/**
 * <p>
 * A texture dictionary is used to track the usage of your textures and supply a single point of access for texture
 * resources. It stores {@link TextureRef}s by their path. If you need to load the same texture in different parts of
 * your application it will only be loaded into memory once by the dictionary.
 * </p>
 * 
 * @deprecated
...
public class TextureDict {
	...
	public static TextureRef loadTexture(String path) {
		return loadTexture(path, TextureFilter.MipMap, TextureFilter.Linear, TextureWrap.ClampToEdge,
	 ...
	 * @return the {@TextureRef} representing the texture.
	 */
	public static TextureRef loadTexture(String path, TextureFilter minFilter, TextureFilter magFilter,
	...
	/**
	 * Removes a texture from the dictionary. In general you should probably not use this - use
	 * {@link TextureRef#unload()} instead.
	 * 
	 * @param path
	 *            to the texture.
	 */
