...
public class KeyframedSubMesh extends SubMesh {
	...
	public KeyframedSubMesh(String name, Mesh mesh, float[] blendedVertices,
			ObjectMap<String, KeyframedAnimation> animations, int animatedComponents, int primitiveType) {
