...
public interface Model {
	 ...
	 * <br />
	 * <strong>Important:</strong> This model must have materials set before you can use this render function. Do that
	 * by using {@link Model#setMaterials(Material...)}.
	 */
	public void render();
	 ...
	 * 
	 * @param program
	 *            The shader program that you will use to draw this object to the screen. It must be non-null.
	 */
	 ...
	 * 
	 * @param subMeshNames
	 *            A list of names of each {@link SubMesh} that is to be extracted from this model.
	...
	/**
	 * @param name
	 *            The name of the {@link SubMesh} to be acquired.
	 ...
	 * {@link BoundingBox} to be one such enclosing box.<br />
	 * Bounding boxes are useful for very basic collision detection amongst other tasks.
	 * 
	 * @param bbox
	 *            The provided {@link BoundingBox} will have its internal values correctly set. (To allow Java Object
	 *            reuse)
	 */
	 ...
	 * 
	 * @param materials
	 *            A list of the materials to set the submeshes to for this model. (The length of the list of materials
	 *            must be the same as the number of SubMeshes in this Model. Failure to do so will result in an
	 ...
	 * 
	 * @param material
	 *            The Material that you wish the whole object to be rendered with.
	 */
	public void setMaterial(Material material);

	/**
	 * This function releases memory once you are done with the Model. Once you are finished with the Model you MUST
	 * call this function or else you will suffer memory leaks.
	 */
	public void dispose();
}
