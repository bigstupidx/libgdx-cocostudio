...
public class TileAtlas implements Disposable {
	...
	/**
	 * Creates a TileAtlas for use with {@link TileMapRenderer}. Run the map through TiledMapPacker to create the files
	 * required.
	 * 
	 * @param map
	 *            The tiled map
	 * @param inputDir
	 *            The directory containing all the files created by TiledMapPacker
	 */
	...
	/**
	 * Releases all resources associated with this TileAtlas instance. This releases all the textures backing all
	 * AtlasRegions, which should no longer be used after calling dispose.
	 */
	@Override
	public void dispose() {
	 ...
	 * 
	 * @param x
	 *            - if <code>true</code> region is flipped on the <b>x</b> axis
	 * @param y
	 *            - if <code>true</code> region is flipped on the <b>y</b> axis
	 */
