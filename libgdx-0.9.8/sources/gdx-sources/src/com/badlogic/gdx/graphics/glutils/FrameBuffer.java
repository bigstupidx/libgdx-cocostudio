 ...
 * will automatically create a texture for the color attachment and a renderbuffer for the depth buffer. You can get a
 * hold of the texture by {@link FrameBuffer#getColorBufferTexture()}. This class will only work with OpenGL ES 2.0.
 * </p>
 * 
 * <p>
...
public class FrameBuffer implements Disposable {
	...
	private void addManagedFrameBuffer(Application app, FrameBuffer frameBuffer) {
		...
		if (managedResources == null)
			managedResources = new ArrayList<FrameBuffer>();
		managedResources.add(frameBuffer);
		buffers.put(app, managedResources);
	}

	/**
	 * Invalidates all frame buffers. This can be used when the OpenGL context is lost to rebuild all managed frame
	 * buffers. This assumes that the texture attached to this buffer has already been rebuild! Use with care.
	 */
