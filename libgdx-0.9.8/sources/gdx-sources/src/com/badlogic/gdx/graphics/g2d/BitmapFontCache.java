...
/**
 * Caches glyph geometry for a BitmapFont, providing a fast way to render static text. This saves needing to compute the
 * location of each glyph each frame.
 * 
 * @author Nathan Sweet
...
public class BitmapFontCache {
	 ...
	 *            the font to use
	 * @param integer
	 *            whether to use integer positions and sizes.
	 */
	 ...
	 * 
	 * @param x
	 *            The x position for the left most character.
	 * @param y
	 *            The y position for the top of most capital letters in the font (the {@link BitmapFont#getCapHeight()
	 *            cap height}).
	 * @param start
	...
	/**
	 * Adds glyphs for the specified text, which may contain newlines (\n). Each line is aligned horizontally within a
	 * rectangle of the specified width.
	 * 
	 * @param x
	 *            The x position for the left most character.
	 * @param y
	 ...
	 *            cap height}).
	 * @param alignment
	 *            The horizontal alignment of wrapped line.
	...
	/**
	 * Clears any cached glyphs and adds glyphs for the specified text, which may contain newlines (\n) and is
	 * automatically wrapped within the specified width.
	 * 
	...
	/**
	 * Adds glyphs for the specified text, which may contain newlines (\n) and is automatically wrapped within the
	 * specified width.
	 * 
	 * @see #addWrappedText(CharSequence, float, float, float, HAlignment)
	 */
	...
	/**
	 * Returns the size of the cached string. The height is the distance from the top of most capital letters in the
	 * font (the {@link BitmapFont#getCapHeight() cap height}) to the baseline of the last line of text.
	 */
