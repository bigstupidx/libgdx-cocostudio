 ...
 * (SharedPreferences on Android, flat file in apps root directory on desktop).
 * </p>
 * 
 * <p>
 * On the desktop the file will be located in the user directory. Make sure you give the preferences instance a name
