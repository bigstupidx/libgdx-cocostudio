...
public class Body {
	...
	/**
	 * Creates a fixture from a shape and attach it to this body. This is a convenience function. Use b2FixtureDef if
	 * you need to set parameters like friction, restitution, user data, or filtering. If the density is non-zero, this
	 ...
	 *            Box2D SetTransform internally calls contactManager.FindNewContacts() method, sometimes multiple bodies
	 *            are updated and it is undesirable to trigger Box2D to find new contacts each time, updateContacts
	 *            should be false in those cases, true otherwise, more information at <a
	 *            href="http://box2d.org/forum/viewtopic.php?f=3&t=8757">Box2d forums</a>.
	 */
	 ...
	 * point of application is not at the center of mass. This wakes up the body.
	 * 
	 * @param impulse
	 ...
	 * 
	 * @param impulseX
	 *            the world impulse vector on the x-axis, usually in N-seconds or kg-m/s.
	 * @param impulseY
	 *            the world impulse vector on the y-axis, usually in N-seconds or kg-m/s.
	 * @param pointX
	...
	/**
	 * Set the mass properties to override the mass properties of the fixtures. Note that this changes the center of
	 * mass position. Note that creating or destroying fixtures can also alter the mass. This function has no effect if
	...
	/**
	 * This resets the mass properties to the sum of the mass properties of the fixtures. This normally does not need to
	 * be called unless you called SetMassData to override the mass and you later want to reset the mass.
	 */
	...
	private native void jniGetLinearVelocityFromWorldPoint(long addr, float worldPointX, float worldPointY,
			float[] linVelWorld); /*
									b2Body* body = (b2Body*)addr;
	...
	private native void jniGetLinearVelocityFromLocalPoint(long addr, float localPointX, float localPointY,
			float[] linVelLoc); /*
								b2Body* body = (b2Body*)addr;
	...
	*/
	...
	/**
	 * Set the active state of the body. An inactive body is not simulated and cannot be collided with or woken up. If
	 * you pass a flag of true, all fixtures will be added to the broad-phase. If you pass a flag of false, all fixtures
	 ...
	 * body are implicitly inactive and will not participate in collisions, ray-casts, or queries. Joints connected to
	 * an inactive body are implicitly inactive. An inactive body is still owned by a b2World object and remains in the
	 * body list.
	 */
	 ...
	 * 
	 * @warning this list changes during the time step and you may miss some collisions if you don't use
	 *          b2ContactListener. Do not modify the returned list!
	 */
