...
public class PolygonShape extends Shape {
	...
	/**
	 * Copy vertices from the given float array. It is assumed the vertices are in x,y order and define a convex
	 * polygon. It is assumed that the exterior is the the right of each edge.
	 */
	...
	/**
	 * Copy vertices from the given float array, taking into account the offset and length. It is assumed the vertices
	 * are in x,y order and define a convex polygon. It is assumed that the exterior is the the right of each edge.
	 */
