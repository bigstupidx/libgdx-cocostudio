...
public class Frustum {
	...
	/**
	 * eight points making up the near and far clipping "rectangles". order is counter clockwise, starting at bottom
	 * left
	 **/
	...
	/**
	 * Returns whether the given sphere is in the frustum not checking whether it is behind the near and far clipping
	 * plane.
	 * 
	 * @param center
	 *            The center of the sphere
