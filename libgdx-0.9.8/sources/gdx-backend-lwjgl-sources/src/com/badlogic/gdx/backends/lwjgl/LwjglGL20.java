...
/**
 * An implementation of the {@link GL20} interface based on LWJGL. Note that LWJGL shaders and OpenGL ES shaders will
 * not be 100% compatible. Some glGetXXX methods are not implemented.
 * 
 * @author mzechner
 */
